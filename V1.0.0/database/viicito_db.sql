...
INSERT INTO `marca` (`id_marca`, `nombre_marca`, `created_at`, `updated_at`) VALUES
(1, 'Bacardí', '2026-05-11 08:31:56', '2026-05-11 08:31:56'),
(2, 'Johnnie Walker', '2026-05-11 08:31:56', '2026-05-11 08:31:56'),
(3, 'Smirnoff', '2026-05-11 08:31:56', '2026-05-11 08:31:56'),
(4, 'José Cuervo', '2026-05-11 08:31:56', '2026-05-11 08:31:56'),
(5, 'Bombay Sapphire', '2026-05-11 08:31:56', '2026-05-11 08:31:56'),
(6, 'Corona', '2026-05-11 08:31:56', '2026-05-11 08:31:56'),
(7, 'Baileys', '2026-05-11 08:31:56', '2026-05-11 08:31:56'),
(8, 'Absolut', '2026-05-11 08:31:56', '2026-05-11 08:31:56');
...
INSERT INTO `producto` (`id_producto`, `id_categoria`, `id_marca`, `codigo_barras`, `sku`, `nombre_producto`, `descripcion`, `precio_compra`, `precio_venta`, `stock_actual`, `grado_alcohol`, `volumen_ml`, `imagen_url`, `stock_minimo`, `stock_maximo`, `estado`, `created_at`, `updated_at`, `deleted_at`) VALUES
(1, 3, 2, 'whisky126', 'whisky126', 'blue label', 'bebida iso.', 80.00, 150.00, 7, 30.00, NULL, 'uploads/productos/1778473999_6a015c0f999a0.jpg', 10, 20, 'Activo', '2026-05-11 08:33:19', '2026-05-18 22:31:07', NULL);
...
ALTER TABLE `marca`
  ...
  ADD UNIQUE KEY `marca_nombre_marca_unique` (`nombre_marca`);
...
ALTER TABLE `producto`
  ...
  ADD KEY `producto_id_marca_foreign` (`id_marca`);
...
ALTER TABLE `producto`
  ...
  ADD CONSTRAINT `producto_id_marca_foreign` FOREIGN KEY (`id_marca`) REFERENCES `marca` (`id_marca`) ON DELETE RESTRICT;
