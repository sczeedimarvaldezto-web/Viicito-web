<template>
  <div class="configuracion-container">
    <div class="mb-4">
      ...
      <p class="text-description">Administra la configuración general del sistema</p>
    </div>
      ...
      <div class="col-md-4 mb-4">
        <div class="card dark-card config-card">
          <div class="card-body dark-card-body">
            ...
            <p class="card-text text-description">Gestiona las categorías de productos</p>
      ...
      <div class="col-md-4 mb-4">
        <div class="card dark-card config-card">
          <div class="card-body dark-card-body">
            ...
            <p class="card-text text-description">Gestiona usuarios y empleados del sistema</p>
      ...
      <div class="col-md-4 mb-4">
        <div class="card dark-card config-card">
          <div class="card-body dark-card-body">
            ...
            <p class="card-text text-description">Parámetros generales del sistema</p>
...
export default {
  ...
  mounted() {
    if (!this.esOwner) {
      alert('Acceso denegado. Solo el propietario puede acceder a configuración.');
