      ...
      <div class="card-body dark-card-body">
        <form @submit.prevent="guardarProducto" ref="form">
          ...
          <div class="row g-3">
            ...
            <div class="col-md-6">
              <label class="form-label">Grado alcohólico <small class="text-muted">(Opcional)</small></label>
              <input
...
export default {
  ...
  methods: {
    ...
    onBarcodeDetected(barcode) {
      this.producto.codigo_barras = barcode;
    },
    ...
    async guardarProducto() {
      ...
      formData.append('grado_alcohol', this.producto.grado_alcohol || null);
